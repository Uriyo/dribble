  ...
  return (
    <div className="flex flex-col md:flex-row bg-no-repeat bg-cover glass-container md:bg-white h-screen">
      <div className="flex backdrop-filter backdrop-blur-lg w-screen h-screen">
        ...
        <div className="p-6 mt-16 sm:mt-10 rounded-lg  max-w-md mx-auto flex flex-col justify-center lg:mx-0">
          <form onSubmit={handleSubmit} className="p-4 bg-white rounded-lg">
            ...
            {Object.values(formErrors).map((error, index) => (
              <p key={index} className="text-red-500 mt-4">
                {"•"} {error}
              </p>
            ))}
            <div className="flex flex-col md:flex-row pt-10">
              <div className="flex flex-col mx-1">
                <label
                  className="text-black  font-bold mb-2 md:mb-0 "
                  htmlFor="name"
                >
                  Name
                </label>
                <input
                  className={` rounded-lg p-2 w-full ${
                    !formErrors.name ? " bg-gray-100" : " bg-red-100"
                  } `}
                  id="name"
                  type="text"
                  placeholder="John"
              ...
              <div className="flex flex-col mx-1 my-8 md:my-0">
                ...
                <input
                  className={` rounded-lg p-2 w-full ${
                    !formErrors.username ? " bg-gray-100" : " bg-red-100"
                  } `}
                  id="username"
                  type="text"
            ...
            <div className="flex flex-col mx-1 pt-2 md:pt-9">
              ...
              <input
                className={` rounded-lg p-2 w-full   ${
                  !formErrors.email ? " bg-gray-100" : " bg-red-100"
                } `}
                id="email"
                type="email"
            ...
            <div className="flex flex-col mx-1 pt-7">
              ...
              <input
                className={`rounded-lg p-2 w-full  ${
                  !formErrors.password ? " bg-gray-100" : " bg-red-100"
                } `}
                id="password"
                type="password"
            ...
            <div className="flex items-center mt-4">
              ...
              />
              <label
                className="text-gray-500 ml-2 mt-2 text-sm md:text-base"
                htmlFor="terms"
              >
